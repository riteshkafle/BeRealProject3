...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func logOut() {
        // Unregister for local notifications when user logs out (stretch feature).
        UNUserNotificationCenter.current().removePendingNotificationRequests(withIdentifiers: ["com.bereal.postReminderQuick", "com.bereal.postReminderDaily"])
